...
const PayrollPage = () => {
  const [employees, setEmployees] = useState([
    {
      ...
      salary: 5000,
      tds: calculateTDS(5000),
      profilePhoto: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsQ-YHX2i3RvTDDmpfnde4qyb2P8up7Wi3Ww&usqp=CAU',
      selected: false,
    },
    {
      id: 2,
  ...
  const handleEmployeeAdd = (event) => {
    ...
    setTotalSalary((prevTotalSalary) => prevTotalSalary + newEmployee.salary);
  ...
  const handleCreditSalary = () => {
    ...
    console.log('Credit salary to selected employees:', selectedEmployees);
  };
    ...
    <div className="container">
      ...
      <div className="row mt-4">
        <div className="col d-flex justify-content-center align-items-end">
          <Button variant="success" onClick={handleCreditSalary}>
            Credit Salary
          </Button>
        </div>
      </div>
